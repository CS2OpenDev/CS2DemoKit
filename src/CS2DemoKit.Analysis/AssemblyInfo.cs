...
// The digest internals (EntityFrameDigest, EntityDigestExtractor, PipelinedDigestSource) are
// implementation details of the entity scanner. The digest-equivalence gate reaches into them
// directly to prove the pipelined digest folds to the sequential one, so it needs the friend
// grant.
